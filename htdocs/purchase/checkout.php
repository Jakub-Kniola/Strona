<?php
    ...
    $statement = mysqli_prepare($connection, 'SELECT products.product_id, products.price, products.discount FROM cart INNER JOIN products ON cart.product_id = products.product_id WHERE user_id = ?');
    ...
    while (mysqli_stmt_fetch($statement)) {
        ...
        $statement2 = mysqli_prepare($connection, 'INSERT INTO purchase VALUES (NULL, ?, ?, ?, CURRENT_TIMESTAMP())');

        mysqli_stmt_bind_param($statement2, 'iii', $user_id, $fetched_product_id, $price);
