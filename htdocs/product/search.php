<?php
    ...
    $query = 'SELECT product_id, title, subtitle, publisher, released, icon, price FROM products ';
    ...
    if (!empty($types)) mysqli_stmt_bind_param($statement, implode('', $types), ...$values);
